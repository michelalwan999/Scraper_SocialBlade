...
Public Class Utilities
    ...
    Public Shared Sub Shuffle_Links(ByVal inputDirectory As String, ByVal outputDirectory As String)
    ...
    Public Shared Function Random_Generator(ByVal largestnumber As Integer) As List(Of Integer)
